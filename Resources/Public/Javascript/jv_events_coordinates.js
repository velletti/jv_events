...
function jv_events_init() {
	...
	if( jQuery('#jv_events_geo').length > 0 ) {
	    if( jQuery('#jv_events_geo').data("askUser") > 0 ) {
...
function jv_events_geodistance() {
    // CONSTX = 71,5
    // CONSTY = 111,3

    // =WURZEL((CONSTX*(Longitude1-Longitude2)*CONSTX*(Longitude1-Longitude2))+(CONSTY*(latitude1-latitude2)*CONSTY*(latitude1-latitude2)))
}
